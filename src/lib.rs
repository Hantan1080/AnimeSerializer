// src/lib.rs
/*
 * Core library for AnimeSerializer
 */
...
#[derive(Debug)]
pub struct AnimeSerializerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeSerializerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeSerializer processing");
    
    let mut processor = AnimeSerializerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeSerializerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeSerializerProcessor::new(false);
